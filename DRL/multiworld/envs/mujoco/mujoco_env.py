...
class MujocoEnv(gym.Env):
    ...
    def viewer_setup(self):
        ...
        """
        pass
        import multiworld.envs.mujoco.cameras as cameras 
        #viewer_camera_init = cameras.ant_u_long_camera
        viewer_camera_init = cameras.ant_fb_med_camera
        viewer_camera_init(self.viewer.cam)
