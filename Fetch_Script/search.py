...
import programskill.dsl as dsl
...
if __name__ == "__main__":
    ...
    program = Program().expand()[0].expand()[6].expand()[0].expand()[0]
    # pdb.set_trace()
    ...
    if args.task == "search":
        node.search()
        df.to_csv(f"pick-final-{args.seed}-{args.random_seed}_random_0.2_100_steps.csv")
    elif args.task == "test":
