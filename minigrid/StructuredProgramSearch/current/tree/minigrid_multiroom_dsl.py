...
def get_abs_state_from_list(lst):
    ...
    state.state["front_is_obj"] = lst[7]
...
def RC_get(object):
    ...
    second_while = WHILE()
    second_while.cond[0] = get_cond(True, "goal_present")
...
def get(object):
    ...
    first_while.stmts[0] = get_action("move", None, None)
