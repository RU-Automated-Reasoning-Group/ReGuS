...
ACTION_DICT = {
    ...
    "toggle": k_action("toggle"),
    "pickup": k_action("pickup"),
    "get_key": k_action("get_key"),
    "get_locked_door": k_action("get_locked_door"),
...
COND_DICT = {
    ...
    "goal_on_left": k_cond(negation=False, cond=k_cond_without_not("goal_on_left")),
    "goal_on_right": k_cond(negation=False, cond=k_cond_without_not("goal_on_right")),
    "goal_present": k_cond(negation=False, cond=k_cond_without_not("goal_present")),
    "front_is_closed_door": k_cond(
        negation=False, cond=k_cond_without_not("front_is_closed_door")
    ),
    "front_is_locked_door": k_cond(
        negation=False, cond=k_cond_without_not("front_is_locked_door")
    ),
    "front_is_wall": k_cond(negation=False, cond=k_cond_without_not("front_is_wall")),
    "front_is_obj": k_cond(negation=False, cond=k_cond_without_not("front_is_obj")),
    "front_is_key": k_cond(negation=False, cond=k_cond_without_not("front_is_key")),
    ...
    "not(goal_on_left)": k_cond(negation=True, cond=k_cond_without_not("goal_on_left")),
    "not(goal_on_right)": k_cond(
        negation=True, cond=k_cond_without_not("goal_on_right")
    ),
    "not(goal_present)": k_cond(negation=True, cond=k_cond_without_not("goal_present")),
    "not(front_is_closed_door)": k_cond(
        negation=True, cond=k_cond_without_not("front_is_closed_door")
    ),
    "not(front_is_locked_door)": k_cond(
        negation=True, cond=k_cond_without_not("front_is_locked_door")
    ),
    "not(front_is_wall)": k_cond(
        negation=True, cond=k_cond_without_not("front_is_wall")
    ),
    "not(front_is_obj)": k_cond(negation=True, cond=k_cond_without_not("front_is_obj")),
    "not(front_is_key)": k_cond(negation=True, cond=k_cond_without_not("front_is_key")),
...
class ABS_STATE:
    def __init__(self):
        self.state = {
            ...
            "goal_on_right": None,
            "goal_present": None,
            "front_is_closed_door": None,
            "front_is_locked_door": None,
            "front_is_wall": None,
            "front_is_obj": None,
            "front_is_key": None,
            "has_key": None,
