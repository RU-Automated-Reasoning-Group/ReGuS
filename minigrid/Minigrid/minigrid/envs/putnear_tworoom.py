...
class PutNearTwoRoomR2LEnv(PutNearTwoRoomEnv):
    def __init__(
        self,
    ...
    def step(self, action):
        if action == 0:
            ...
            assert False
        _, rwd, terminated, truncated, info = PutNearTwoRoomEnv.step(self, real_action)
    ...
    def reset(self, *, seed: int | None = None, options=None):
        PutNearTwoRoomEnv.reset(self, seed=seed, options=options)
