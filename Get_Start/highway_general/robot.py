...
class HighwayRobot:
    def __init__(self, task='highway-v0', seed=999, config_set=None, view='TTC', eval=False):
        # init environment
        self.task = task
        self.seed = seed
    ...
    def check_reward(self):
        ...
        if self.cur_reward != -1:
            ...
            # log_and_print("seed {}, cur_reward {}, reward_steps {}, r {}".format(self.seed, self.cur_reward, self.reward_steps, self.cur_reward / self.reward_steps))
